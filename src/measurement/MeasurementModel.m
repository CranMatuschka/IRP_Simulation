classdef MeasurementModel < handle
    ...
    methods
        ...
        function [extraTruth_m, extraModel_m, budget] = ...
            ...
            context = struct();
            context.useHardwareDelay = obj.useHardwareDelay;
            context.txHardwareDelay_m = obj.txHardwareDelay_m;
            context.towerTxSignalDelay_m = ...
                obj.towers{towerIndex}.txSignalDelay_m;
            context.rxHardwareDelay_m = obj.rxHardwareDelay_m;
            context.txHardwareDelayModel_m = obj.txHardwareDelayModel_m;
            context.rxHardwareDelayModel_m = obj.rxHardwareDelayModel_m;

            context.useMultipathDelay = obj.useMultipathDelay;
            context.multipathDelay_m = obj.multipathDelay_m;
            context.multipathDelayModel_m = obj.multipathDelayModel_m;
            context.multipathStochasticMinimumElevation_deg = ...
                obj.multipathStochasticMinimumElevation_deg;
            context.multipathStochasticRandomSeed = ...
                obj.multipathStochasticRandomSeed;

            if obj.useMultipathDelay
                [context.multipathStochasticTruth_m, ...
                        context.multipathSigma_m, ...
                        context.multipathElevation_deg] = ...
            ...
            context.useAntennaDelay = obj.useAntennaDelay;
            context.antennaDelay_m = obj.antennaDelay_m;
            context.antennaDelayModel_m = obj.antennaDelayModel_m;
            if obj.useAntennaDelay
                context.txAntennaCorrection_m = ...
                    obj.towers{towerIndex}.txAntennaCorrection_m( ...
                    receiverEci_m, jd);
                context.rxAntennaCorrection_m = ...
                    spaceAsset.rxAntennaCorrection_m( ...
                    receiverIndex, towerEci_m);
            end

            context.useSagnacCorrection = obj.useSagnacCorrection;
            context.sagnacCorrection_m = obj.sagnacCorrection_m;
            context.sagnacCorrectionModel_m = obj.sagnacCorrectionModel_m;

            context.useTowerSurveyError = obj.useTowerSurveyError;
            if obj.useTowerSurveyError
                context.truthTowerPositionOffsetEcef_m = ...
                    obj.towers{towerIndex}.truthPositionOffsetEcef_m;
                context.modelTowerPositionOffsetEcef_m = ...
                    obj.towers{towerIndex}.modelPositionOffsetEcef_m;
                context.truthTowerSurvey_m = obj.towerSurveyRangeEffect_m( ...
                    jd, ...
                    towerEci_m, ...
                    receiverEci_m, ...
                    context.truthTowerPositionOffsetEcef_m);
                context.modelTowerSurvey_m = obj.towerSurveyRangeEffect_m( ...
                    jd, ...
                    towerEci_m, ...
                    receiverEci_m, ...
                    context.modelTowerPositionOffsetEcef_m);
            ...
            [extraTruth_m, extraModel_m, budget] = ...
                ErrorBudget.nonAtmospheric(context);
        end
