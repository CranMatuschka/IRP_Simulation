classdef ReverseGnssSimulation < handle
    ...
    methods (Access = private)
        ...
        function step(obj, k)
            ...
            truth = obj.measurementModel.makePseudoranges( ...
                jd, datetimeUtc, towersEci, groundResidualTruth_m, ...
                obj.truthAsset, obj.towerClockEkfEnabled(), ...
                GroundTimingNetwork.residualVariance_m2(obj.cfg, obj.c));

            model = obj.measurementModel.predictPseudorangesWithJacobian( ...
                jd, datetimeUtc, towersEci, groundResidualModel_m, ...
                truth.visibilityMask, obj.estAsset, obj.estTowerClockBias_m, ...
                obj.idx, obj.stateDim, obj.towerClockEkfEnabled());

            innovationRange = MeasurementAlgebra.residual(truth.y, model.yhat);

            [yUpdate, ypUpdate, Hupdate, Rupdate] = ...
                ClockGaugeConstraint.append( ...
                truth.y, model.yhat, model.H, truth.R, ...
                obj.estTowerClockBias_m, obj.estTowerClockDrift_mps, ...
                obj.idx, obj.stateDim, obj.towerClockEkfEnabled(), ...
                obj.cfg, obj.cfg.ekf, obj.numTowers);
            obj.latestRrange = truth.R;
            ...
            postfitModel = obj.measurementModel.predictPseudorangesWithJacobian( ...
                jd, datetimeUtc, towersEci, groundResidualModel_m, ...
                truth.visibilityMask, obj.estAsset, obj.estTowerClockBias_m, ...
                obj.idx, obj.stateDim, obj.towerClockEkfEnabled());

            postfitRange = MeasurementAlgebra.residual(truth.y, postfitModel.yhat);

            obj.recordHistory(k, truth.y, innovationRange, postfitRange, S, Hupdate, ...
                nisValue, truth.trueRange_rt, truth.los_rt, ...
                truth.receiverEci, towersEci, groundResidualTruth_m, groundTrue_m, ...
                groundCorrection_m, truth.visibilityMask, truth.elevation_rt, ...
                truth.atmosphere.delay_rt_m, ...
                truth.atmosphere.troposphere_rt_m, ...
                truth.atmosphere.ionosphere_rt_m, ...
                truth.atmosphere.residualByTower_m, ...
                truth.atmosphere.troposphereResidualByTower_m, ...
                truth.atmosphere.ionosphereResidualByTower_m, ...
                truth.atmosphere.troposphereDiagnostics, ...
                truth.atmosphere.ionosphereDiagnostics, ...
                model.atmosphere.delay_rt_m, ...
                model.atmosphere.troposphere_rt_m, ...
                model.atmosphere.ionosphere_rt_m, ...
                model.atmosphere.troposphereDiagnostics, ...
                model.atmosphere.ionosphereDiagnostics);
        end
