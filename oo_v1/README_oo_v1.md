...
| Item | Value |
|------|-------|
| Stage | **30** — Main-Script Validation Gate Restoration |
| Branch | `feature/oo-reverse-gnss-v1` |
| Validation mode | Targeted random smoke (4 selected tests, seed 30; **full suite not run**) |
...
setenv('OO_V1_VALIDATION_STAGE','30')
run_oo_reverse_gnss_report
```

This will:
1. Select 4 random tests (seed 30), force `test_stage30*` if present
