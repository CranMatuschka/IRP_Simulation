...
| Validation mode | Targeted random smoke (4 selected tests, seed 31; **full suite not run**) |
...
setenv('OO_V1_VALIDATION_STAGE','31')
run_oo_reverse_gnss_report
```

This will:
1. Select 4 random tests (seed 31), force `test_stage31*` if present
