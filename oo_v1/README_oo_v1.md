...
| Item | Value |
|------|-------|
| Stage | **80** — Realistic Propagation and One-Way Timing Consistency |
| Branch | `feature/oo-reverse-gnss-v1` |
| Validation mode | Main-script validation gate (4 selected tests, seed 80; **full suite not run**) |
...
setenv('OO_V1_VALIDATION_STAGE','80')
