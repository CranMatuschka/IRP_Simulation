...
| Item | Value |
|------|-------|
| Validation version | **2.01** — report content/format version (no stage numbering) |
| Branch | `feature/truth-estimation-separation` |
...
The main script runs a formal synthetic validation campaign inside a single invocation.
