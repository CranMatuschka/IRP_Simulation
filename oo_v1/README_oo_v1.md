...
| Item | Value |
|------|-------|
| Stage | **82** — Source-Truth Integrity and J2 Dynamics Mismatch Validation |
| Branch | `feature/oo-reverse-gnss-v1` |
| Validation mode | Main-script validation gate (4 selected tests, seed 82; **full suite not run**) |
