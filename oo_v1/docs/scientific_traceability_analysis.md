...
- **Verdict**: ⚠️ The *implementation* is verified to machine precision; the *primary sourcing of Table 2 is not yet closed*. See Critical analysis.
- **Sources**:
  - Recommendation ITU-R P.676-13 (08/2022), Annex 1 — line-by-line method; Table 1 (44 oxygen lines), Table 2 (35 water-vapour lines), equations (1)–(9). [Coefficients transcribed via the ITU-Rpy reference implementation's v13 data files, **not read from the Recommendation PDF**, which is a scanned image and would not extract.]
