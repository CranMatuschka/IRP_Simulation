...
%   Delegates VERBATIM to revgnss.IonosphereModel — there is no physics here. The
...
%   (cfg is accepted for signature uniformity across effect façades; ionosphere ignores it.)
    switch mode
        case 'model'
            out.codeDelay_m    = revgnss.IonosphereModel.applyCodeSign( ...
                args.delayPrimary_m, args.signalName, args.primaryName);
            out.carrierDelay_m = revgnss.IonosphereModel.applyCarrierSign( ...
                args.delayPrimary_m, args.signalName, args.primaryName);
        case 'covariance'
            [out.c1, out.c2] = revgnss.IonosphereModel.ionoFreeCoefficients( ...
                args.f1_Hz, args.f2_Hz);
        case 'diagnostic'
            out.scale = revgnss.IonosphereModel.scaleForSignal( ...
