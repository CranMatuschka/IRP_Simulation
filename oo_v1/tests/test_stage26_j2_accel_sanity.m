...
r_equator = [r_eq; 0; 0];
a_j2 = models.orbit.OrbitDynamics.j2Accel_mps2(r_equator);
...
r_pole = [0; 0; r_eq];
a_j2_pole = models.orbit.OrbitDynamics.j2Accel_mps2(r_pole);
...
a_tb  = models.orbit.OrbitDynamics.twoBodyAccel_mps2(r_geo);
a_j2_geo = models.orbit.OrbitDynamics.j2Accel_mps2(r_geo);
...
a_tb_eq = models.orbit.OrbitDynamics.twoBodyAccel_mps2(r_equator);
