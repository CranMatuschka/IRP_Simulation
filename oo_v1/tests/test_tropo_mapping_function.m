...
mf_zenith = revgnss.MappingFunctions.troposphere(pi/2, 'simple');
assert(abs(mf_zenith - 1.0) < 1e-10, ...
    'Zenith mapping function should be 1.0, got %.6f', mf_zenith);

% 30 deg elevation: mf = 1/sin(30 deg) = 2.0
mf_30 = revgnss.MappingFunctions.troposphere(30*pi/180, 'simple');
...
mf_low = revgnss.MappingFunctions.troposphere(0.001, 'simple');
...
mf_cf = revgnss.MappingFunctions.troposphere(30*pi/180, 'continuedFraction');
