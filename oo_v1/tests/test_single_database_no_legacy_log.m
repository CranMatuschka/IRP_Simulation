...
assert(isa(sim.simData, 'revgnss.SimulationDataStore'), ...
    sprintf('T1 FAIL: sim.simData class is %s, expected revgnss.SimulationDataStore', ...
    class(sim.simData)));
fprintf('T1 PASS: sim.simData is revgnss.SimulationDataStore\n');

% =========================================================================
% T2: sim.diag returns sim.simData (backward-compat)
% =========================================================================
fprintf('\nT2: sim.diag backward-compatibility getter...\n');
assert(isa(sim.diag, 'revgnss.SimulationDataStore'), ...
