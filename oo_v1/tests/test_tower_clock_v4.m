...
if ~isempty(es6c)
    ...
    hasWarn = contains(wid, 'productEpoch') || contains(wmsg, 'negative') || ...
              contains(wmsg, 'Product epoch');
    assert(hasWarn, 'T6c FAILED: no warning emitted for negative product epoch');
