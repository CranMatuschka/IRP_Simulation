...
% Wrapper parity
assert(abs(revgnss.MeasurementModel.codeSignalSigma(sigCfg, pi/6, cfg_const) - sigma_c) < 1e-12, ...
...
% Wrapper parity
assert(strcmp(revgnss.MeasurementModel.zwdMappingKind(cfg_cf), 'continuedFraction'), ...
