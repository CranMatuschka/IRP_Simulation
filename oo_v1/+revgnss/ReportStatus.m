classdef ReportStatus
    ...
    methods (Static)
        ...
        function s = current()
            s.stage      = '85';
            s.stageTitle = 'Formal Synthetic Validation Campaign and Statistical Consistency Audit';
            ...
            s.validationArtifactFresh = (vsStageNum == 85) && strcmp(vsSHA, runtimeSHA);
            if ~s.validationArtifactFresh
                s.validationWarnings{end+1} = ...
                    'No fresh local validation summary for this commit. Run: setenv(''OO_V1_VALIDATE_REPORT'',''true''); setenv(''OO_V1_VALIDATION_STAGE'',''85''); run_oo_reverse_gnss_report';
            end
            ...
            s.missingScientificStages = revgnss.StageHistory.missingScientificItems(85);
