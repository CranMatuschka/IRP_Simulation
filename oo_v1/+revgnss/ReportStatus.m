classdef ReportStatus
    ...
    methods (Static)
        ...
        function s = current()
            s.stage      = '64';
            s.stageTitle = 'Scientific Closure and v1 Freeze';
            ...
            s.validationArtifactFresh = (vsStageNum >= 64) && strcmp(vsSHA, runtimeSHA);
            if ~s.validationArtifactFresh
                s.validationWarnings{end+1} = ...
                    'No fresh local validation summary for this commit. Run: setenv(''OO_V1_VALIDATE_REPORT'',''true''); setenv(''OO_V1_VALIDATION_STAGE'',''64''); run_oo_reverse_gnss_report';
            end
            ...
            s.missingScientificStages = revgnss.StageHistory.missingScientificItems(64);
