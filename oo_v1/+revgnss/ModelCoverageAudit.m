    ...
    methods (Static, Access = private)
        ...
        function cats = buildCategories_(cfg)
            ...
            c{end+1} = revgnss.ModelCoverageAudit.cat_( ...
                ...
                sprintf('mode=%s; doubleCountGuard=%s; Doppler derivative=simplifiedV1', sagMode, dcGuard));
            ...
            if covEn
                c{end+1} = revgnss.ModelCoverageAudit.cat_( ...
                    ...
                    'Stage 74 code block-R: tower clock correlation applied; carrier/Doppler diagonal; partial NIS documented');
            else
                c{end+1} = revgnss.ModelCoverageAudit.cat_( ...
