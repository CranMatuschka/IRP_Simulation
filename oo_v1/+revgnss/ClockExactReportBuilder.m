    ...
    methods (Static, Access = private)
        ...
        function writeScenarioSummary_(fid, cfg, summary, diag, nTwr, nRx, dur, dt, esc)
            ...
            fprintf(fid, ['This report documents a reverse-GNSS simulation run using the oo\\_v1 ' ...
                'MATLAB simulator. ' ...
                'The ground segment transmits reverse-GNSS pseudorange observations to a GEO space receiver. ' ...
            ...
            fprintf(fid, ['\\textbf{Clock architecture:} \\texttt{%s}. ' ...
                ...
                'separated without an external datum or gauge constraint. ' ...
            ...
            fprintf(fid, '\\midrule\n');
            stRows = { ...
                '1','$\delta r_{I,x}$','ECI X position','m','Coupled to velocity'; ...
                '2','$\delta r_{I,y}$','ECI Y position','m','Coupled to velocity'; ...
                '3','$\delta r_{I,z}$','ECI Z position','m','Coupled to velocity'; ...
                '4','$\delta v_{I,x}$','ECI X velocity','m/s','Affects future position'; ...
                '5','$\delta v_{I,y}$','ECI Y velocity','m/s','Affects future position'; ...
                '6','$\delta v_{I,z}$','ECI Z velocity','m/s','Affects future position'; ...
        ...
        function writeStateEstimation_(fid, plotPaths, stem, cfg, diag, figDir)
            ...
            if doAtt
                CE.writeRow_(fid, '', ...
                    ...
                    ['Attitude is observable only through non-zero receiver lever arms. ' ...
                     'A receiver at the centre of mass gives zero attitude sensitivity. ' ...
                     'Plot not generated in this oo\_v1 run.']);
            else
                CE.writeRow_(fid, '', ...
                    'EKF Attitude States', ...
                    ['Attitude estimation is not active in this run ' ...
                     '(single receiver at centre of mass). No plot generated.']);
            end
        ...
        function writeDisabledComponents_(fid, cfg)
            ...
            if ~CE.getLogical_(cfg,{'measurements','carrierPhase','useInEKF'},false)
