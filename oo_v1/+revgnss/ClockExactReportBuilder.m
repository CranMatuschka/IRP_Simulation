classdef ClockExactReportBuilder
    ...
    methods (Static, Access = private)
        ...
        function writeActivePhysicsConfig_(fid, cfg, summary, plotPaths, stem, figDir)
            ...
            fprintf(fid, 'J2 mismatch policy & \\texttt{%s}; J2 accel @ GEO: %.2e~m/s$^2$; process-noise consistency: \\texttt{%s}\\\\\n', ...
            ...
            fprintf(fid, 'Doppler Stage~83 frameConsistentV2: ECI-consistent range-rate (tower rotational velocity / Sagnac-rate capturedByTowerVelocityTerm); product-drift model included; lever-arm velocity and relativistic range-rate not implemented.\\\\\n');
