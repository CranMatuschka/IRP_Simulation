    ...
    methods (Static)
        ...
        function list = missingScientificItems(~)
            ...
            list = {
                ...
                'Integer ambiguity fixing for carrier IF (LAMBDA/MLAMBDA; Stage 47 adds float IF rows; Stage 48 adds float traceability; Stage 49 adds float WL/NL diagnostics; Stage 50 adds readiness gate; Stage 51 hardens readiness evidence; Stage 52 exports arc evidence; Stage 53 adds arc-separated float ambiguities; Stage 54 enforces arc-consistent carrier combinations; no integer fixing, no calibrated phase-bias products, no PPP-grade)'
