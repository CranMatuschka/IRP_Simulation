...
simConfig.spaceAssets.receivers = [ ...
    makeReceiverComponentConfig(1, 1, 'GEO-1-RX-CENTER', true, ...
        [0.0; 0.0; 0.0], 0.02); ...
    makeReceiverComponentConfig(2, 1, 'GEO-1-RX-X-PLUS', false, ...
        [2.0; 0.0; 0.0], 0.02); ...
    makeReceiverComponentConfig(3, 1, 'GEO-1-RX-X-MINUS', false, ...
        [-2.0; 0.0; 0.0], 0.02); ...
    makeReceiverComponentConfig(4, 1, 'GEO-1-RX-Y-PLUS', false, ...
        [0.0; 2.0; 0.0], 0.02); ...
    makeReceiverComponentConfig(5, 1, 'GEO-1-RX-Y-MINUS', false, ...
        [0.0; -2.0; 0.0], 0.02); ...
    makeReceiverComponentConfig(6, 1, 'GEO-1-RX-Z-PLUS', false, ...
        [0.0; 0.0; 2.0], 0.02) ...
];

simConfig.spaceAssets.assets(1).receivers = simConfig.spaceAssets.receivers;
...
function receiver = makeReceiverComponentConfig(id, parentAssetIndex, name, enabled, offsetBody_m, pseudorangeSigma_m)
    receiver = struct();
    receiver.id = id;
    receiver.parentAssetIndex = parentAssetIndex;
    receiver.name = name;
    receiver.enabled = enabled;
    receiver.offsetBody_m = offsetBody_m(:);
    receiver.pseudorangeSigma_m = pseudorangeSigma_m;
