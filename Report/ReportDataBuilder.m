classdef ReportDataBuilder
    ...
    methods (Static, Access = private)
        ...
        function budget = atmosphereBudgetForReport(sim)
            if isfield(sim.history, 'errorBudget') && ...
                    isfield(sim.history.errorBudget, 'atmosphere')
                budget = sim.history.errorBudget.atmosphere;
                return;
            end

            budget = struct();
            budget.truthTotal_m = sim.history.atmosphere.truth.total_m;
            budget.modelTotal_m = sim.history.atmosphere.model.total_m;
            budget.residualTotal_m = sim.history.atmosphere.residual.total_m;
            budget.sameTowerVariance_m2 = ...
                sim.history.atmosphere.covariance.totalVariance_m2;
            budget.independentVariance_m2 = 0.0;

            budget.components = struct();
            budget.components.troposphere = struct( ...
                'truth_m', sim.history.atmosphere.truth.troposphere_m, ...
                'model_m', sim.history.atmosphere.model.troposphere_m, ...
                'residual_m', sim.history.atmosphere.residual.troposphere_m);
            budget.components.ionosphere = struct( ...
                'truth_m', sim.history.atmosphere.truth.ionosphere_m, ...
                'model_m', sim.history.atmosphere.model.ionosphere_m, ...
                'residual_m', sim.history.atmosphere.residual.ionosphere_m);

            budget.covariance = struct( ...
                'sigma_m', sim.history.atmosphere.covariance.totalSigma_m, ...
                'variance_m2', ...
                    sim.history.atmosphere.covariance.totalVariance_m2, ...
                'correlationModel', ...
