classdef ReportDataBuilder
    ...
    methods (Static)
        function reportData = fromSimulation(sim)
            ...
            reportData = BuilderFieldCopier.copyNamedFields(reportData, sim.history, [
                "innovation_rms_m"
            ...
            reportData = BuilderFieldCopier.copyNamedFields(reportData, sim.history, [
                ...
                "H_pos_rank_history"
                "H_att_rank_history"
                "H_pos_att_clock_rank_history"
                "H_rx_clock_bias_column_norm_history"
                "pseudorange_measurement_count"]);
            ...
            reportData = ReportDataBuilder.addLegacyAtmosphereFields( ...
                reportData, sim.history);
            ...
            reportData.truth_total_residual_config_sigma_m = hypot( ...
                ...
                reportData.truth_ionosphere_residual_config_sigma_m);
            atmosphereBudget = ...
                ReportDataBuilder.atmosphereBudgetForReport(sim);
            ...
            reportData.atmosphere_troposphere_residual_by_receiver_tower_m = ...
                atmosphereBudget.components.troposphere.residual_m;

            reportData.atmosphere_ionosphere_residual_by_receiver_tower_m = ...
                atmosphereBudget.components.ionosphere.residual_m;
            ...
            reportData.mean_deterministic_atmosphere_model_residual_m = ...
                mean(sim.history.errors.atmosphere.deterministicResidual_m(:), ...
                'omitnan');

            reportData.model_atmosphere_residual_variance_m2 = ...
                mean(atmosphereBudget.sameTowerVariance_m2(:), ...
                'omitnan');

            reportData.model_atmosphere_covariance_structure = ...
                string(atmosphereBudget.covariance.correlation_model);
            ...
            reportData = BuilderFieldCopier.copyNamedFields(reportData, sim.history, [
                "los_unit_eci_by_receiver_tower"
    ...
    methods (Static, Access = private)
        function out = addLegacyAtmosphereFields(out, history)
            ...
            out = ReportDataBuilder.copyPrefixedFields( ...
                out, diagnostics.truth.ionosphere, ...
                "atmosphere_truth_ionosphere_", ...
                ReportDataBuilder.ionosphereDiagnosticNames());
            out = ReportDataBuilder.copyPrefixedFields( ...
            ...
            out = ReportDataBuilder.copyPrefixedFields( ...
                ...
                ReportDataBuilder.troposphereDiagnosticNames());
            out = ReportDataBuilder.copyPrefixedFields( ...
        ...
        function budget = atmosphereBudgetForReport(sim)
            errors = sim.history.errors;
            budget = struct();
            budget.truthTotal_m = errors.atmosphere.truth_m;
            budget.modelTotal_m = errors.atmosphere.model_m;
            budget.residualTotal_m = errors.atmosphere.residual_m;
            budget.sameTowerVariance_m2 = errors.atmosphere.variance_m2;
            budget.independentVariance_m2 = 0.0;

            budget.components = struct();
            budget.components.troposphere = struct( ...
                'truth_m', errors.troposphere.truth_m, ...
                'model_m', errors.troposphere.model_m, ...
                'residual_m', errors.troposphere.residual_m);
            budget.components.ionosphere = struct( ...
                'truth_m', errors.ionosphere.truth_m, ...
                'model_m', errors.ionosphere.model_m, ...
                'residual_m', errors.ionosphere.residual_m);

            budget.covariance = struct( ...
                'sigma_m', errors.atmosphere.sigma_m, ...
                'variance_m2', errors.atmosphere.variance_m2, ...
                'correlationModel', ...
                    string(errors.atmosphere.correlationModel), ...
                'correlation_model', ...
                    string(errors.atmosphere.correlationModel));
        end
