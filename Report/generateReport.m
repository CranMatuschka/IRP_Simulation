function generateReport(reportData, reportConfig, reportToggles)
    ...
    stochasticTruthResidualPlotsEnabled = ...
        atmospherePlotsEnabled && ...
        isfield(reportData, "atmosphere_truth_residual_by_tower_m") && ...
        isfield(reportData, "atmosphere_truth_troposphere_residual_by_tower_m") && ...
        isfield(reportData, "atmosphere_truth_ionosphere_residual_by_tower_m") && ...
        any(isfinite(reportData.atmosphere_truth_residual_by_tower_m(:)));
    ...
    report = appendReportRow(report, stochasticTruthResidualPlotsEnabled, ...
        plot_paths.stochastic_truth_residuals, ...
