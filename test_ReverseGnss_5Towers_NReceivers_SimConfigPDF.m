...
function runStochasticTruthResidualDocumentationRegression()
    ...
    assert(contains(configText, ...
        ...
        'SimulationConfig should document troposphere truth residual output.');

    assert(contains(configText, ...
            'atmosphere_truth_ionosphere_residual_by_tower_m'), ...
        'SimulationConfig should document ionosphere truth residual output.');

    assert(contains(configText, ...
            'atmosphere_truth_residual_by_tower_m'), ...
        'SimulationConfig should document total truth residual output.');
...
function assertDeterministicAtmosphereCase( ...
    ...
    assert(isfield(reportData, 'atmosphere'), ...
        'Report data must expose structured atmosphere diagnostics.');
