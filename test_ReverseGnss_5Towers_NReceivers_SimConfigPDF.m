...
function runTroposphereTruthModelMismatchRegression()
    ...
    troposphereResidual_m = ...
        reportData.atmosphere_troposphere_residual_by_receiver_tower_m(:, :, 1);

    totalAtmosphereResidual_m = ...
        reportData.atmosphere_residual_by_receiver_tower_m(:, :, 1);
    ...
    assert(isfield(reportData, 'troposphere_profile_summary_table'), ...
        'Troposphere mismatch report data should include the troposphere profile summary table.');
