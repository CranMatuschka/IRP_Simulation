...
function runIonexHistoryReportDiagnosticsRegression()
    ...
    assert(all(abs( ...
        results.history.diagnostics.atmosphere.model.ionosphere.vtec_TECU(:, :, 1) - ...
...
function runPropagationCorrectionScaffoldRegression()
    ...
    assert(isfield(results.history.diagnostics, 'propagation'), ...
...
function assertDeterministicAtmosphereCase( ...
    ...
    assert(~isfield(results, 'non_atmospheric'), ...
        'results.non_atmospheric is forbidden; use results.history.errors.');
    assert(~isfield(results, 'propagation'), ...
        'results.propagation is forbidden; use results.history errors and diagnostics.');
    assert(~isfield(results, 'legacy'), ...
